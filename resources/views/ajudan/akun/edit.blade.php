...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form onsubmit="$('#submit').prop('disabled',true)" action="/akun/update/{{ $user->id }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-3">
                                <label for="defaultconfig-6" class="col-form-label">Pegawai</label>
                            </div>
                            <div class="col-lg-8">
                                <div class="col-lg-9 inline">
                                    <input class="form-control me-2" maxlength="255"
                                        value="@foreach ($pegawai as $pg){{ $pg->nama_pegawai }} @endforeach" type="text"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" maxlength="100" name="password" id="defaultconfig-2"
                                    placeholder="Kosongkan jika tidak ingin mengganti password" type="password">
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <select class="form-select" name="id_role" data-width="100%">
                                    <option selected hidden value="{{ $user->role->id }}">{{ $user->role->role }}</option>
                                    @foreach ($role as $rl)
