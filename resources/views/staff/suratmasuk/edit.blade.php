...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form onsubmit="$('#submit').prop('disabled',true)" action="/suratmasuk/update/{{ $suratmasuk->id }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" maxlength="100" name="pengirim"
                                    value="{{ $suratmasuk->pengirim }}" id="defaultconfig" autocomplete="off" type="text"
                                    required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" maxlength="100" name="no_surat"
                                    value="{{ $suratmasuk->no_surat }}"id="defaultconfig-2"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea" class="form-control" id="defaultconfig-4"name="perihal" maxlength="2500"
                                    rows="8" placeholder="" required>{{ $suratmasuk->perihal }}</textarea>
                            </div>
                        </div>
