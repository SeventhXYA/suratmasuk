...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ubah Jabatan</li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-lg-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form onsubmit="$('#submit').prop('disabled',true)" action="/jabatan/update/{{ $jabatan->id }}"
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" maxlength="25" name="jabatan" id="defaultconfig"
                                    value="{{ $jabatan->jabatan }}" type="text">
                            </div>
                        </div>
