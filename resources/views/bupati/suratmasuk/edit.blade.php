...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form onsubmit="$('#submit').prop('disabled',true)" action="/statusapproval/update/{{ $status->id }}"
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-8">
                                <select class="form-select" name="status" data-width="100%">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ url('/daftarsuratmasuk') }}" type="button" class="btn btn-secondary me-2"
