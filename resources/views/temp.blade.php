...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Tempat Sampah</a></li>
            <li class="breadcrumb-item active" aria-current="page">Sampah Surat Masuk</li>
        </ol>
    </nav>
                        ...
                        <table id="dataTableExample" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Perihal</th>
                                    <th style="width:1rem;">Dihapus Oleh</th>
                                ...
                                @foreach ($suratmasuk as $sm)
                                    @php
                                        $pegawai = DB::table('tb_pegawai')
                                            ->join('tb_user', 'tb_pegawai.user_id', '=', 'tb_user.id')
                                            ->select('tb_pegawai.nama_pegawai')
                                            ->where('tb_user.id', $sm->deleted_by)
                                            ->first();
                                    @endphp
                                    <tr>
                                        ...
                                        <td class="d-flex inline">
                                            <form action="{{ route('restore-data', ['id' => $sm->id]) }}" method="POST">
                                                @csrf
                                                <button type="submit" class="btn btn-outline-info btn-icon btn-xs"
                                                    data-id="{{ $sm->id }}"><i data-feather="refresh-ccw"
