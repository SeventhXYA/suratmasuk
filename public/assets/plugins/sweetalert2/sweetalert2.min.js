!(function (e, t) {
        ...
        F = (e, t) => {
            ...
            switch (t) {
                ...
                case "radio":
                    return (
                        e.querySelector(
                            ".".concat(h.radio, " input:checked")
                        ) ||
                        e.querySelector(
                            ".".concat(h.radio, " input:first-child")
                        )
                    );
                case "range":
    ...
    const ht = ["swal-title", "swal-html", "swal-footer"],
        ...
        Pt = (e, t) => {
            ue && te(t)
                ? ((e.style.overflowY = "hidden"), t.addEventListener(ue, xt))
    ...
    e = Object.freeze({
        ...
        getInput: function (e) {
            ...
            return (e = he.domCache.get(e || this))
                ? F(e.popup, t.input)
                : null;
        },
        close: st,
        ...
        _main: function (e, t = {}) {
            Ze(Object.assign({}, t, e)),
                Me.currentInstance &&
                    (Me.currentInstance._destroy(), M() && ot()),
        ...
        _destroy: function () {
            ...
            t &&
                ...
                Me.deferDisposalTimer &&
                    (clearTimeout(Me.deferDisposalTimer),
